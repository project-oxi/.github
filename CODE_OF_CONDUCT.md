# Contributor Covenant Code of Conduct — project-oxi

## Our Pledge

We as members, contributors, and leaders pledge to make participation in the **project-oxi** community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all project-oxi community spaces — GitHub repositories under `project-oxi/*`, GitHub Issues, GitHub Discussions, and any other official project-oxi communication channel. It also applies when an individual is officially representing the community in public spaces.
...
For answers to common questions about this code of conduct, see the [FAQ](https://www.contributor-covenant.org/faq). Translations are available at the [Contributor Covenant i18n page](https://www.contributor-covenant.org/translations).